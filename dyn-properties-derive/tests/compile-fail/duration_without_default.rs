...
// the "Duration fields must have #[default(...)]" rule without depending on the facade
// crate (which would be a circular dev-dependency for this proc-macro crate's own tests).
struct Duration;
